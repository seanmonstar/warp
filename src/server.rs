...
impl TcpKeepaliveConfig {
    fn configure(&self, incoming: &mut AddrIncoming) {
        incoming.set_keepalive(self.time);
        incoming.set_keepalive_interval(self.interval);
        incoming.set_keepalive_retries(self.retries);
    }
}
